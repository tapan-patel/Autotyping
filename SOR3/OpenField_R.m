...
inner_BW_L = imerode(Info.ROIs.surface_right,ones(ceil(2*periphery*px_per_inch_L)));
outer_BW_L = Info.ROIs.surface_right - inner_BW_L;
...
% TimeOuter = TimeOuter + TimeCorners;
% TimeInner = TimeInner + TimeCenter;